...
const htmlPath = path.join(__dirname, '../src/assignments/list.html');

if (!fs.existsSync(htmlPath)) {
  describe('HTML File Check', () => {
    test(`The file 'list.html' should exist`, () => {
  ...
  describe('TASK4104 Header Structure', () => {
  ...
  describe('TASK4105 Main Element', () => {
