...
const htmlPath = path.join(__dirname, '../src/resources/list.html');
...
if (!fs.existsSync(htmlPath)) {
  ...
  describe('TASK2104 Header Structure', () => {
  ...
  describe('TASK2105 Main Element', () => {
