...
const htmlPath = path.join(__dirname, '../src/weekly/list.html');

if (!fs.existsSync(htmlPath)) {
  describe('HTML File Check', () => {
    test(`The file 'weekly-breakdown.html' should exist`, () => {
  ...
  describe('TASK3104 Header Structure', () => {
  ...
  describe('TASK3105 Main Element', () => {
